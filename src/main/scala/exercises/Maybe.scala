...
// Define a generic abstract class Maybe
...
// Define a singleton object MaybeNot representing an empty Maybe
...
// Define a case class Just which wraps an existing value
