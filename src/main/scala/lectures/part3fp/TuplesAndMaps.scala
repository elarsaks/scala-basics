...
object TuplesAndMaps extends App {
  ...
  // Maps - keys -> values
  val phonebook = Map("Jim" -> 555, "Daniel" -> 789, ("JIM", 333)).withDefaultValue(-1)
  println(phonebook)
  ...
  /*
    1. What would happen if I had two original entries "Jim" -> 55 and "JIM" -> 9000
  ...
  def nPeopleWithNoFriends(network: Map[String, Set[String]]): Int =
    network.count(_._2.isEmpty) // network.count(pair => pair._2.isEmpty)
